# HubRepoMeta contract (schema)

Per-repository settings and message channels. One instance per `repo_prefix`.
Keeps heavy / appendable data off the global HubRegistry Discover singleton.

## Addressing

Parameters = UTF-8:

`gitatlas-repo-v1:` + `repo_prefix`
...
`gitatlas.repo-meta.upsert.v1\0` + nul fields:
...
Domain: `gitatlas.repo-meta.append-public.v1\0` + nul:
...
Domain: `gitatlas.repo-meta.append-private.v1\0` + nul:
