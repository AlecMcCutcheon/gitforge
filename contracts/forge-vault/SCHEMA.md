# GitForge vault contract (schema)
...
`gitforge-vault-v1:` + lowercase hex of `blake3("gitforge-vault-v1" ‖ seed)`
...
signing seeds for GitForge Pages (`forge-pages-<prefix>`). Ciphertext is public;
...
`gitforge.vault.v4\0` + nul fields:
...
- Wrap key = `blake3("gitforge.vault.identity-dek-wrap-v1\0" ‖ identity_sk)`.
