...
export function BrandLogo({
  ...
  return (
    ...
    >
      <defs>
        <clipPath id="freenethub-mark-clip">
          <circle cx="32" cy="32" r="32" />
        </clipPath>
      </defs>
      <circle cx="32" cy="32" r="32" fill="#ffffff" />
      <g clipPath="url(#freenethub-mark-clip)">
        <g transform={MARK_TRANSFORM}>
          <path fill="#0d1117" fillRule="evenodd" d={BIRD_PATH} />
        </g>
      </g>
    </svg>
  );
